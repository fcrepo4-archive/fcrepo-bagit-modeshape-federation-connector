...
public class BagInfoTest {
    ...
    public void setUp() throws IOException {
        ...
        final ByteArrayInputStream bytes =
                new ByteArrayInputStream("Bag-Count: 1 of 1".getBytes("UTF-8"));
    ...
    public void testSave() throws IOException {
        final BagInfoTxtWriter mockWriter = mock(BagInfoTxtWriter.class);
    ...
    public void testGetProperties() {
        final Property mockProp = mockProperty("Bag.Count", "2 of 5");
        when(mockPF.create(any(Name.class), eq("1 of 1"))).thenReturn(mockProp);
        final Map<Name, Property> props = testObj.getProperties();
    ...
    private static Property mockProperty(final String name, final String value) {

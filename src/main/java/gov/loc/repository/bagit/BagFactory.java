...
public class BagFactory {
     ...
     */
    public enum Version {
        V0_93("0.93"), V0_94("0.94"), V0_95("0.95"), V0_96("0.96"), V0_97(
                "0.97");
        ...
        public static Version valueOfString(final String versionString) {
     ...
     */
    public Bag createBag(final Version version) {
     ...
     * bag.
     */
    public Bag createBag(final File bagFile) {
     ...
     */
    public Bag createBag(final File bagFile, final LoadOption loadOption) {
        final String versionString = BagHelper.getVersion(bagFile);
     ...
     */
    public Bag createBagByPayloadFiles(final File bagFile,
            final Version version,
            final List<String> ignoreAdditionalDirectories) {
        final Bag bag = this.createBag(version);
        bag.setFile(bagFile);
     ...
     * @param loadOption The mechanism to use for loading the bag.
     */
    public Bag createBag(final File bagFile, final Version version,
            final LoadOption loadOption) {
        final Bag bag = this.createBag(version);
        bag.setFile(bagFile);
     ...
     */
    public Bag createBag(final Bag bag) {
        if (bag.getFile() == null) {
            return createBag(bag.getBagConstants().getVersion());
        }
        return createBag(bag.getFile(), bag.getBagConstants().getVersion(),
                LoadOption.NO_LOAD);
    }
     ...
     */
    public BagPartFactory getBagPartFactory(final Version version) {
        if (Version.V0_93.equals(version)) {
            return new gov.loc.repository.bagit.v0_93.impl.BagPartFactoryImpl(
                    this, this.getBagConstants(version));
        }
        if (Version.V0_94.equals(version)) {
            return new gov.loc.repository.bagit.v0_94.impl.BagPartFactoryImpl(
                    this, this.getBagConstants(version));
        }
        if (Version.V0_95.equals(version)) {
        ...
        if (Version.V0_97.equals(version)) {
            return new gov.loc.repository.bagit.v0_97.impl.BagPartFactoryImpl(
                    this, this.getBagConstants(version));
        }
        throw new RuntimeException("Not yet supported");
    }
     ...
     */
    public BagConstants getBagConstants(final Version version) {
        if (Version.V0_93.equals(version)) {
     ...
     */
    public PreBag createPreBag(final File dir) {
        final PreBag preBag = new PreBagImpl(this);
        preBag.setFile(dir);
        return preBag;
    }
